...
export default function AIErrorAlert({ error, onRetry, className = '' }: AIErrorAlertProps) {
  ...
  return (
    <div 
      className={`rounded-2xl border backdrop-blur-md p-5 transition-all duration-300 relative overflow-hidden bg-rose-950/15 border-rose-900/30 text-rose-200 ${className}`}
    >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {onRetry && (
              <button
                onClick={onRetry}
                className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl text-xs font-semibold transition-all border bg-white/5 hover:bg-white/10 border-white/10 text-white"
              >
            ...
            <button
              ...
              className="flex items-center gap-1 px-3 py-1.5 rounded-xl text-xs font-medium transition-all hover:bg-white/5 text-rose-300"
            >
          ...
          {showDetails && (
            <div className="mt-3 p-3 rounded-xl text-[10px] font-mono overflow-x-auto max-h-32 relative bg-black/20 border border-white/5 text-rose-300/80">
