...
import { Sparkles, Mail, Lock, AlertCircle, User, Check, Eye, EyeOff, ArrowLeft } from 'lucide-react';
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4" autoComplete="off">
            {!isForgotPassword && isRegistering && (
              ...
              >
                <label className="block text-[11px] font-bold uppercase tracking-wider mb-2 ml-1 transition-colors duration-500 text-slate-400">Full Name</label>
                <div className="relative mb-2">
                  <User className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 transition-colors duration-500 text-slate-400" />
                  <input
                    type="text"
                    name="user_fullname"
                    autoComplete="off"
                    ...
                    className="w-full pl-11 pr-4 py-3 rounded-xl border focus:ring-1 transition-all outline-none bg-white/[0.02] border-white/[0.08] focus:border-[#7c6af7]/80 focus:ring-[#7c6af7]/30 text-white placeholder-slate-500"
                  />
                </div>
              </motion.div>
            )}
            ...
            <div>
              <label className="block text-[11px] font-bold uppercase tracking-wider mb-2 ml-1 transition-colors duration-500 text-slate-400">Email Address</label>
              <div className="relative">
                <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 transition-colors duration-500 text-slate-400" />
                <input
                  type="text"
            ...
            {!isForgotPassword && (
              <div>
                <div className="flex justify-between items-center mb-2 ml-1">
                  <label className="block text-[11px] font-bold uppercase tracking-wider transition-colors duration-500 text-slate-400">Password</label>
                  {!isRegistering && (
                    <button
                      type="button"
                      onClick={() => {
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`text-[10px] font-semibold transition-colors duration-300 ${password.length >= 8 ? 'text-emerald-400' : 'text-slate-500'}`}>Min 8 characters</span>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`text-[10px] font-semibold transition-colors duration-300 ${/[A-Z]/.test(password) ? 'text-emerald-400' : 'text-slate-500'}`}>Uppercase letter</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className={`w-4 h-4 rounded-full flex items-center justify-center transition-colors duration-300 ${/[a-z]/.test(password)
                        ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/20'
                    ...
                    <span className={`text-[10px] font-semibold transition-colors duration-300 ${/[a-z]/.test(password) ? 'text-emerald-400' : 'text-slate-500'}`}>Lowercase letter</span>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`text-[10px] font-semibold transition-colors duration-300 ${/[^A-Za-z0-9]/.test(password) ? 'text-emerald-400' : 'text-slate-500'}`}>Special character</span>
                  </div>
                </div>
              </motion.div>
            )}
            ...
            {!isForgotPassword && isRegistering && (
              <motion.div
                ...
                className="overflow-hidden"
              >
                <label className="block text-[11px] font-bold uppercase tracking-wider mb-2 ml-1 transition-colors duration-500 text-slate-400">Confirm Password</label>
                <div className="relative mb-2">
                  <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 transition-colors duration-500 text-slate-400" />
                  <input
            ...
            {!isForgotPassword && isRegistering && (
              ...
              >
                <input
                  ...
                  className="mt-0.5 rounded focus:ring-offset-0 focus:ring-1 w-3.5 h-3.5 transition-all border-white/[0.1] bg-white/[0.02] text-[#7c6af7] focus:ring-[#7c6af7]/30"
                />
                <label htmlFor="agreeTerms" className="text-xs leading-normal select-none transition-colors duration-500 text-slate-400">
                  I agree to the{' '}
          ...
          {!isForgotPassword && (
            <>
              <div className="flex items-center gap-3 my-6">
                <span className="flex-1 border-t transition-colors duration-500 border-white/[0.06]" />
                <span className="font-bold tracking-widest text-[9px] uppercase shrink-0 transition-colors duration-500 text-slate-500">
                ...
                {googleClientConfigured ? (
                  <>
                    ...
                    <button
                      ...
                      className="w-full py-3 px-4 rounded-xl border flex items-center justify-center gap-3 text-xs font-semibold transition-all duration-300 hover:scale-[1.01] bg-white/[0.03] border-white/[0.08] text-slate-200 hover:bg-white/[0.08]"
                    >
                  ...
                  <div className="w-full p-3 rounded-xl border text-[10px] text-center leading-relaxed transition-all duration-500 bg-amber-500/5 border-amber-500/10 text-amber-500/70">
