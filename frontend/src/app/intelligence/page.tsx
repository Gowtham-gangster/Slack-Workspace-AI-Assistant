...
import {
  ...
  Smile, Meh, Frown, Activity, Hash, Zap
} from 'lucide-react';
...
export default function IntelligencePage() {
  ...
  const card = "rounded-2xl border transition-all bg-white/[0.03] border-white/[0.07]";
      ...
      <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 md:px-8 py-6 md:py-8">
        ...
        <div className="mb-6 md:mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-xl md:text-2xl font-bold text-white">Workspace Intelligence</h1>
              <p className="text-xs md:text-sm text-slate-400">AI-powered insights from your Slack workspace</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 xl:gap-8">
          ...
          <div className={`${card} p-6`}>
            <div className="flex items-center gap-2 mb-5">
              ...
              <h2 className="text-sm font-bold text-white">Trending Topics</h2>
            </div>
            {topicsLoading ? (
              ...
              <div className="space-y-2">
                {topics.slice(0, 8).map((t: any) => (
                  <div key={t.topic} className="flex items-center gap-3 p-2.5 rounded-xl group transition-all"
                    ...
                    <span className="text-sm font-medium flex-1 text-slate-200">{t.topic}</span>
          ...
          <div className={`${card} p-6`}>
            <div className="flex items-center gap-2 mb-5">
              ...
              <h2 className="text-sm font-bold text-white">Team Activity</h2>
            </div>
            {teamLoading ? (
              <div className="space-y-3">
                {[...Array(5)].map((_, i) => (
                ...
                {teamActivity.slice(0, 8).map((m: any, i: number) => {
                  ...
                  return (
                    <div key={m.userId} className="flex items-center gap-3">
                      ...
                      <span className="text-xs font-bold shrink-0 text-slate-400">{m.messageCount}</span>
                    </div>
                  );
                })}
              </div>
          ...
          <div className={`${card} p-6`}>
            <div className="flex items-center gap-2 mb-5">
              ...
              <h2 className="text-sm font-bold text-white">Sentiment Analysis</h2>
            </div>
                ...
                <div className="flex justify-center mb-4">
                  <div className="relative w-24 h-24">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                      <span className="text-xl font-bold text-white">{sentimentData.score}</span>
              ...
              <div className="space-y-2">
                {channelHealth.slice(0, 8).map((ch: any) => (
                  <div key={ch.id} className="flex items-center gap-3 p-2.5 rounded-xl"
                    ...
                    <span className="text-xs font-medium flex-1 truncate text-slate-200">{ch.name}</span>
